...
export const cloudWatchLogGroupsDescribeResponse = {
  logGroups: [
    {
...
export const describeSubscriptionFilterResponse = {
  subscriptionFilters: [{
...
export const getAllCloudWatchLogGroupsResponse = [
  {
    logGroupName: '/aws/lambda/instrumentation-gateway-pu-queue-process',
    creationTime: 1504217911320,
    metricFilterCount: 0,
...
export const iAmGetRoleResponse = {
  ResponseMetadata: {
  ...
  Role: {
    ...
    AssumeRolePolicyDocument:
        '%7B%22Version%22%3A%222008-10-17%22%2C%22Statement%22%3A%5B%7B%22Effect%22%3A%22Allow%22%2C%22Principal%' +
